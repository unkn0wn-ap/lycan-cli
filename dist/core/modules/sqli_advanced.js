...
exports.runAdvancedSqli = runAdvancedSqli;
// ═══════════════════════════════════════════════════════════════════════════
...
// Helper Functions
// ═══════════════════════════════════════════════════════════════════════════
function detectDBMS(responseBody) {
...
function getPayloadsByDepth(depth) {
    switch (depth) {
        case 'basic':
            return [
...
// ═══════════════════════════════════════════════════════════════════════════
async function runAdvancedSqli(hostname, config) {
    const findings = [];
    const testEndpoints = [
        '/search?q=',
        '/user?id=',
