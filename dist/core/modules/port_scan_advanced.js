...
exports.runAdvancedPortScan = runAdvancedPortScan;
 ...
 */
function fingerprintService(port, banner) {
 ...
 */
async function lookupCVEs(service, version) {
...
// ═══════════════════════════════════════════════════════════════════════════
async function runAdvancedPortScan(hostname, config) {
    const findings = [];
